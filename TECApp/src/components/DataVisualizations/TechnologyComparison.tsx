...
import { getAbbrv, getTechnologyColor } from '../../util/ValueDictionaries'
...
export const TechnologyComparison = ({region, data}: TechnologyComparisonProps)=>{
            ...
            <View style={{ width: '100%' }}>
              ...
              <View style={styles.graphContainer}>
                <View style={styles.graphInnerContainer}>
                  ...
                  <GraphKey label="HYDROPOWER" color={getTechnologyColor('Hydropower')} />
                  <GraphKey label="GEOTHERMAL" color={getTechnologyColor('Geothermal')} />
                  <GraphKey label="BIOMASS" color={getTechnologyColor('Biomass')} />
                  <GraphKey label="NUCLEAR" color={getTechnologyColor('Nuclear')} />
                  <LineGraph
                    yMin={yMin}
                    yMax={yMax}
                    lineCurves={[{ curve: solar_curve, color: getTechnologyColor("Solar") },
